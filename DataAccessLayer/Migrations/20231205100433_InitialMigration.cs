        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Scholarships_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Scholarships_Classes_Id",
                        column: x => x.Id,
                        principalTable: "Classes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Scholarships_Students_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherSubjectClassId = table.Column<int>(type: "int", nullable: true),
                    TeacherSubjectSubjectId = table.Column<int>(type: "int", nullable: true),
                    TeacherSubjectTeacherId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherSubjects", x => new { x.ClassId, x.SubjectId, x.TeacherId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_TeacherSubjectClassId_TeacherSubjectSubjectId_TeacherSubjectTeacherId",
                table: "Subjects",
                columns: new[] { "TeacherSubjectClassId", "TeacherSubjectSubjectId", "TeacherSubjectTeacherId" });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Subjects_TeacherSubjects_TeacherSubjectClassId_TeacherSubjectSubjectId_TeacherSubjectTeacherId",
                table: "Subjects",
                columns: new[] { "TeacherSubjectClassId", "TeacherSubjectSubjectId", "TeacherSubjectTeacherId" },
                principalTable: "TeacherSubjects",
                principalColumns: new[] { "ClassId", "SubjectId", "TeacherId" });
        }
